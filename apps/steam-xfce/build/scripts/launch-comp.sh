...
function launcher() {
  ...
  # Setup autostart directory and Steam autostart
  mkdir -p $HOME/.config/autostart
  if [ -f "/opt/gow/xfce4/autostart/steam.desktop" ]; then
    cp /opt/gow/xfce4/autostart/steam.desktop $HOME/.config/autostart/
