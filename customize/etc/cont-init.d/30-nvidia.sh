...
if [ -d /usr/nvidia ]; then
  ...
  if [ -d /usr/nvidia/share/egl/egl_external_platform.d ]; then
    ...
    cp /usr/nvidia/share/egl/egl_external_platform.d/* /usr/share/egl/egl_external_platform.d/ || true
  fi

  if [ -d /usr/nvidia/share/glvnd/egl_vendor.d ]; then
    gow_log "[nvidia] Add egl-vendor"
    mkdir -p /usr/share/glvnd/egl_vendor.d/
    cp /usr/nvidia/share/glvnd/egl_vendor.d/* /usr/share/glvnd/egl_vendor.d/ || true
